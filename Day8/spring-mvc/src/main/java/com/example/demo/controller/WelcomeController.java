...
//		 template.postForObject("http://localhost:8080/api/v1/students", requestBody, Student.class);
//	 }
//	 return nextStep;
//	
//   }
...
//
//    Student[] resp =template.getForObject("http://localhost:8080/api/v1/students",Student[].class);
//
